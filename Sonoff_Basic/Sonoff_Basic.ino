...
const PROGMEM char* MQTT_CLIENT_ID = "s26_1";
...
// MQTT: topics
const char* MQTT_LIGHT_STATE_TOPIC = "home/plug2/status";
const char* MQTT_LIGHT_COMMAND_TOPIC = "home/plug2/switch";

// payloads by default (on/off)
const char* LIGHT_ON = "ON";
const char* LIGHT_OFF = "OFF";

const PROGMEM uint8_t RELAY_PIN = 12;
const PROGMEM uint8_t LED_PIN = 13;
